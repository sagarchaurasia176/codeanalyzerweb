            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-center">Install Extension</h3>
                        <p className="text-gray-400 text-center">Add our extension to Chrome with just one click from the Chrome Web Store.</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-center">Write Your Code</h3>
                        <p className="text-gray-400 text-center">Continue coding as usual in your favorite online editor or platform.</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-center">Get Instant Analysis</h3>
                        <p className="text-gray-400 text-center">See real-time complexity analysis appear right in your editor.</p>
                    </motion.div>
                </motion.div>
                <br />
                ...
                <div className="text-purple-500 mb-4 bg-slate-800 flex flex-col md:flex-row px-6 md:px-12 py-8 items-center justify-between gap-8">
                    ...
                    <div className='w-full md:w-1/2 text-center md:text-left space-y-2'>
                        ...
                        <p className="text-lg">Start analyzing your code complexity in seconds</p>
                    </div>
